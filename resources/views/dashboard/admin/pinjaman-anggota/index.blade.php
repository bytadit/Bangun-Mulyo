...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
        @slot('li_3')
            Anggota Kelompok {{ $kelompok_name }}
        @endslot
        @slot('li_3_link')
            {{ route('anggota-kelompok.index', ['kelompok' => $kelompok]) }}
        @endslot
        @slot('title')
            {{ $title }}
        @endslot
                                        ...
                                        <table class="table table-borderless align-middle">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td> : </td>
                                                    <td>
                                                        <h6 class="fs-15 mb-1">{{ $pinjaman_anggota->count() == 0 ? 'Belum Diatur' : $pinjaman_anggota->first()->pinjaman_ke }}</h6>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="fw-medium">
                                                    ...
                                                    <td>
                                                        <h6 class="fs-15 mb-1">
                                                            @if($pinjaman_anggota->count() == 0)
                                                                Belum Diatur
                                                            @elseif($pinjaman_anggota->count() > 0)
                                                                @currency($pinjaman_anggota->first()->nilai_angsuran)
                                                            @endif
                                                        </h6>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td> : </td>
                                                    <td>
                                                        <h6 class="fs-15 mb-1">{{ $pinjaman_anggota->count() == 0 ? 'Belum Diatur' : date('d-m-Y', strtotime($pinjaman_anggota->first()->tgl_pinjaman)) }}</h6>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="fw-medium">
                                                    ...
                                                    <td> : </td>
                                                    <td>
                                                        <h6 class="fs-15 mb-1">{{ $pinjaman_anggota->count() == 0 ? 'Belum Diatur' : date('d-m-Y', strtotime($pinjaman_anggota->first()->tgl_pencairan)) }}</h6>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="fw-medium">
                                                    ...
                                                    <td> : </td>
                                                    <td>
                                                        <h6 class="fs-15 mb-1">{{ $pinjaman_anggota->count() == 0 ? 'Belum Diatur' : date('d-m-Y', strtotime($pinjaman_anggota->first()->tgl_pelunasan)) }}</h6>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center fw-medium">
                                                    <button class="btn btn-sm btn-soft-warning mx-1"  data-bs-toggle="modal" data-bs-target="#editDataAngsuranAnggota{{$angsuran->id}}">
                                                        <i class="ri-pencil-line"></i> <span >@lang('Ubah')</span>
                                                    </button>
                                                    <button class="btn btn-sm btn-soft-danger ml-1" data-bs-toggle="modal" data-bs-target="#deleteDataAngsuranAnggota{{$angsuran->id}}">
